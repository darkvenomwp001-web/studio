...
import type { Story, User as AppUser, Announcement, UserSummary } from '@/types';
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2 mt-4 md:mt-0 self-center md:self-end">
              {isOwnProfile ? (
                ...
                <>
                  <Button onClick={() => isFollowing ? unfollowUser(profileUser.id) : followUser(profileUser.id)} disabled={followActionLoading} variant={isFollowing ? "outline" : "default"} className="min-w-[120px] w-full sm:w-auto">
        ...
        <Tabs defaultValue={defaultTab} className="w-full">
          ...
          <TabsContent value="works" className="mt-8 animate-in fade-in duration-500">
            ...
            {isOwnProfile && privateWorks.length > 0 && (
              <section>
                <h2 className="text-xl font-headline font-semibold mb-4 text-accent flex items-center gap-2">
