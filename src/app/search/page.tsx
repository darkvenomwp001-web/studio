...
export default function SearchResultsPage() {
  ...
  if (!query) {
    return (
      <div className="text-center py-10">
        <h1 className="text-2xl font-headline mb-4">Search LitVerse</h1>
        <p className="text-muted-foreground">Please enter a search term in the bar above to find stories and authors.</p>
      </div>
    );
  }

  const noResults = filteredStories.length === 0 && filteredAuthors.length === 0;
